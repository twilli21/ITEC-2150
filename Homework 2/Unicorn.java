 ...
 * Written: 9/17/2019
 * Description: Holds the information of a unicorn's name, weapon, and magic
 * 
 */
public class Unicorn extends LifeForm
{
	 ...
	 * @param magic
	 */
	public Unicorn(String name, String weapon, int magic)
	{
		this.name = name;
		this.weapon = weapon;
		this.magic = magic;
	 ...
	 * @param type
	 */
	public Unicorn(int hitPoints, int strength, String type)
	{
